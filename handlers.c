...
* Otherwise - 0
*/
unsigned char handle_length(const char *modifier, cahr *index)
{
if (*modifier == 'h')
{
(*index)++;
...
/**
*handle_width - Matches a width modifiers with corresponding values.
*@args: A va_list of arguments.
*@modifier: A pointer to a potential width modifier.
*@index: An index counter for the original format string.
*
*Return: If a width modifier is matched - its corresponding value.
* Otherwise - 0 
*/
int handle_width(va_list args, const char *modifier, char *index)
{
...
/**
*handle_precision - Matches a precison modifier with corresponding values.
*@args: A va_list of arguments.
